...
set -e
cd "$(dirname "$0")/.."
for dir in nodes/master2master nodes/bridges/uvc_camera nodes/bridges/feetech_servos nodes/lerobot_teleop nodes/filter_node nodes/test_joint_api nodes/bno095_imu nodes/haptic_controller; do
  echo "Linting $dir ..."

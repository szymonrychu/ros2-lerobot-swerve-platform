...
def _create_bno055(i2c_bus: int, i2c_address: int) -> tuple[Any, int]:
    ...
    for addr in addresses:
        try:
            ...
            # ACCGYRO: raw accel + gyro only — no fusion/calibration needed, guarantees real data (incl. gravity ~9.8)
...
def run_imu_node(config: ImuNodeConfig) -> None:
    ...
    # ACCGYRO mode: read raw acceleration (includes gravity) and gyro; orientation unknown
